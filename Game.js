...
export default function Game() {
    ...
    // to set the handler the keycode.. i.e the move
  ...
  // gives a random position to apple 
    const createApple = () =>
...
//dount
    ...
    return (
      ...
      <div {... handlers} className="game">
        <div id="title"><h1 style={{color: "#6CBB3C"}}>SPIT SNAKE</h1><h1 style={{color: "#EB4C42"}}> GAME</h1></div>
        <canvas
      ...
      <div className="toggles">
        <div className="buttons">
          {score>0 && <div id="score"><p>Score:</p><p style={{color: "black"}}>{score}</p></div>}
